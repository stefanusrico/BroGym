...
<section class="content">
  ...
  <div class="card">
    ...
    <div class="card-body p-0" style="margin: 20px">
      ...
      <table id="previewTrainer" class="table table-striped table-bordered display" style="width:100%">
        <thead>
          <tr>
            <th>Nama</th>
            <th>Gaji</th>
...
$(document).ready(function() {
  $('#previewTrainer').DataTable({
    "processing": true,
    "serverSide": true,
    "ajax": {
      "url": "{{ route('trainers.getDataTrainer') }}",
      "dataType": "json",
      "type": "POST",
      "data": {
        _token: "{{ csrf_token() }}"
  ...
  // hapus data
  $('#previewTrainer').on('click', '.hapusData', function() {
    var id = $(this).data("id");
      ...
      if (result.isConfirmed) {
        $.ajax({
          ...
          success: function(response) {
            ...
            $('#previewTrainer').DataTable().ajax.reload();
          }
        });
      }
    })
