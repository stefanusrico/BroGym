        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              ...
              <img src="{{ Auth::user()->user_image }}" class="profile-user-img img-fluid img-circle"
                alt="User Imagess">
              @else
              <img src="{{ asset('vendor/adminlte3/img/user2-160x160.jpg') }}"
                class="profile-user-img img-fluid img-circle" alt="User Imagess">
              @endif
              {{-- <img
          ...
          <div class="card-body">
            <div class="tab-content">
              ...
              <div class="tab-pane" id="updateData">
                <div class="row">
                  <div class="col-md-6">
                    <form action="{{ route('profile.update',['type'=>'change_profile']) }}" method="post"
                        ...
                        <div class="card-body">
                          <div class="form-group">
                            ...
                            <input type="text" id="inputName" name="name"
                              ...
                              value="{{ Auth::user()->name }}" required="required" autocomplete="name">
                            @error('name')
                          ...
                          <div class="form-group">
                            ...
                            <input type="email" id="inputEmail" name="email"
                              ...
                              value="{{ Auth::user()->email }}" required="required" autocomplete="email">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                          ...
                          <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                @if (Auth::user()->user_image)
                                <img class="elevation-3" id="prevImg" src="{{ Auth::user()->user_image }}"
                                  width="150px" />
                                @else
                                <img class="elevation-3" id="prevImg"
                                  src="{{ asset('vendor/adminlte3/img/user2-160x160.jpg') }}" width="80px" />
                                @endif
                              </div>
                              <div class="col-md-8">
